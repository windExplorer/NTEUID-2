...
# 等级 -> (显示文字, 主色)。覆盖 drive 八档，统一横向授带徽章风格。
# S/A/B 沿用原仓库 texture2d 的配色以保持辨识度，仅换为新形状；其余按阶位递增配色。
RANKS: dict[str, tuple[str, tuple[int, int, int]]] = {
    "D": ("D", (140, 142, 150)),     # 灰
    "C": ("C", (74, 168, 86)),       # 绿
    "B": ("B", (36, 121, 188)),      # 蓝（同原 S/A/B 配色）
    "A": ("A", (134, 35, 171)),      # 紫（同原 S/A/B 配色）
    "S": ("S", (239, 151, 1)),       # 橙金（同原 S/A/B 配色）
    "SS": ("SS", (222, 48, 48)),     # 红：高于 S
